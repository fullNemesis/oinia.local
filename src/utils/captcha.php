<?php
        ...
        $caracter = 0;
            while ($caracter < $totalCharacteres) {
                $captcha .= substr($posiblesLetras, rand(0, strlen($posiblesLetras) - 1), 1); // Se extrae 1 letra de $possiblesLetras de la posición aleatoria según el tamaño de la variable.
                $caracter++;
            }
        ...
        $colorAzul = imagecolorallocate($imagen, 0, 0, 220);
