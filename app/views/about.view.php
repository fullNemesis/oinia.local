    ...
    <!-- Container Box -->
      ...
      <!-- Clients Feedback -->
        ...
        foreach ($imagenesClientes as $imagen){ ?>
          <div class="col-xs-12 col-sm-3">
          <img class="img-responsive" src="<?php echo $imagen->geturlclientes();?>">
          <h5><?= $imagen->getDescripcion() ?> </h5>
          <q>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor dignissimos et tempore iste, iusto eaque totam sed,
           aliquam voluptate repellendus nisi repudiandae facilis fugit corporis recusandae vitae eligendi sequi architecto.</q>
          </div>
        <?php } ?>
        </div>
